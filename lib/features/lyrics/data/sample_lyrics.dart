...
/// Sample lyrics for demo mode. Only Yamunashtak has real text; the other
/// entries reuse it so every list row opens something.
final Map<String, Lyrics> sampleLyrics = {
  'yamunashtak': _yamunashtak,
  for (final id in [
    'madhurashtakam',
    'chalo-sakhi-yamuna-tat',
    'aarti-yamunaji',
    'aarti-shrinathji',
    'jago-mohan-pyare',
    'jai-jai-shri-vallabh',
    'maiya-mori',
    'sarvottam-stotra',
  ])
    id: Lyrics(bhajanId: id, byScript: _yamunashtak.byScript),
};

const Lyrics _yamunashtak = Lyrics(
